...
def screen_admin_dashboard(user):
    ...
    with tabs[0]: # Dashboard
        ...
        col1.metric("Total Profissionais", len(df[df['Role']!='admin']))
...
def screen_user_dashboard(user):
    ...
    with tabs[2]:
        ...
        st.write("Descreva suas técnicas, especialidades e público-alvo. Essa informação ajuda a gestão a direcionar pacientes.")
